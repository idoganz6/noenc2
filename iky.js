...
////< DAFTAR BUTTON BY follow @vinzstore_1 > ////
...
Saya LuciverBot, Bot WhatsApp yang membantu kamu mempermudah sesuatu seperti Membuat Sticker dan Lainnya`

               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'List Menu'},type:1},{buttonId:`${prefix}rules`,buttonText:{displayText:'Rules'},type:1},{buttonId:`${prefix}sewabot`,buttonText:{displayText:'SewaBot'},type:1}]
...
reply('1 untuk mengaktifkan, 0 untuk menonaktifkan')
 ...
 buttonsMessage = {footerText:'follow @vinzstore_1', imageMessage: imageMsg,
...
▹ ${prefix}bokep25
 ...
 sendButMessage(from, menu, `created follow @vinzstore_1`, [
 {
buttonId: noprefix ? "menu" : "!"+"menu",
buttonText: {
  displayText: `⬡ BACK TO MENU `,
...
groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
 ...
 Wa.me/6285929939498`
 sendButMessage(from, titid, `follow @vinzstore_1 `, [
 {
...
if (!q) return reply('Linknya?')
 ...
 data = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=IkyAdss&url=${q}`)
...
//------------------< Menunya Bang:v >-------------------
case 'infoig':
reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/vinzstore_1/`)
break
case 'ikyygroup':
