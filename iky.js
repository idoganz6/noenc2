...
////< DAFTAR BUTTON BY follow @call.me.ido > ////

const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan ${botName} Verify Terlebih Dahulu Ya `
const daftar2 = '```Ketik Tombol Di Bawah Untuk Verify Kak\Luciverbot```'
...
tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK @prefixverify UNTUK MENDAFTAR DI Luciver BOTZ`
ind = {
...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentai/${budy}?apikey=53afc106252108ea4668c313`)
...
var pdf = await axios.get(`https://api.lolhuman.xyz/api/nhentaipdf/${budy}?apikey=53afc106252108ea4668c313`)
...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentaisearch?apikey=53afc106252108ea4668c313&query=${budy}`)
...
if (!isPremium) return reply(`khusus premium`)
 ...
 try {
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam1?apikey=53afc106252108ea4668c313&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam2?apikey=53afc106252108ea4668c313&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam3?apikey=53afc106252108ea4668c313&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam4?apikey=53afc106252108ea4668c313&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam5?apikey=53afc106252108ea4668c313&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam6?apikey=53afc106252108ea4668c313&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam7?apikey=53afc106252108ea4668c313&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam8?apikey=53afc106252108ea4668c313&nomor=${args[1]}`)
reply("Success")
 } catch (err) {
sendMess(ownerNumber, `${command} Error:` + err)
reply(mess.error.api)
...
Ini adalah bot Luciver yg bisa membantu anda !
contoh command simpel

# *!sticker* yaitu untuk membuat sticker di Luciver *kirim/reply foto* dengan caption *!sticker*
...
This is a Luciver bot that can help you!
simple command example 

# *!sticker* is to make a sticker on Luciver *send/reply a photo* with the caption *!sticker* 
...
Saya LuciverBot, Bot Luciver yang membantu kamu mempermudah sesuatu seperti Membuat Sticker dan Lainnya`

               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'List Menu'},type:1},{buttonId:`${prefix}anonymous`,buttonText:{displayText:'ANONYMOUS'},type:1},{buttonId:`${prefix}sewabot`,buttonText:{displayText:'SewaBot'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© Creator Luciverbot\nNote : Jika Pkai Wa Gb silahkan ketik #command', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
case  'anonymous':
   menu =` LUCIVER BOTぽ 以 `
    ...
    {buttonId: `${prefix}leave`, buttonText: {displayText: 'LEAVE'}, type: 1},
               ...
               imageMsg = (await ikyy.prepareMessageMedia(fs.readFileSync(`./media/Menu.jpg`), 'imageMessage', { thumbnail:fake, contextInfo:{forwardingScore: 989, isForwarded: true }})).imageMessage

               buttonsMessage = {
               contentText: `${menu}`,
               footerText:  `                 
Ketik start untuk memulai chat,next untuk mencari
dan leave untuk mengakhiri.ANONYMOUS tidak bisa 
digunakan di group silahkan chat pribadi
...
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕
 ...
 ️ꪶ𖣂ꫂ Juan ボ GANZ 〽 @idoganz1`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
▹ ${prefix}wallgravity text1 text2
 `
  sendButMessage(from, wibu, `created follow @call.me.ido`, [
  {
...
reply('1 untuk mengaktifkan, 0 untuk menonaktifkan')
 ...
 buff = await getBuffer(`http://lolhuman.herokuapp.com/api/meme/darkjoke?apikey=53afc106252108ea4668c313`, {method: 'get'})
 buttons = [{buttonId: noprefix ? "infoig" : "!"+"infoig",buttonText:{displayText: ` ©Luciver bot`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @call.me.ido', imageMessage: imageMsg,
 contentText:`©Luciver bot`,buttons,headerType:4}
 prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
 ikyy.relayWAMessage(prep)
 break
 case 'ephoto':
...
reply(`Kirim foto atau reply foto yang sudah dikirim, dengan caption ${prefix}wasted`)
 ...
 buttons = [{buttonId: `${prefix}infoig`,buttonText:{displayText: ` ©Luciver bot`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @call.me.ido', imageMessage: imageMsg,
 contentText:`©Luciver bot`,buttons,headerType:4}
 prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
 ...
 break
  case 'indonesia':                       
	    	...
	    	ikyy.sendMessage(from, pideo, image, {quoted: freply})			
            break
            case 'thailand':                       
...
reply('Loading...')
lah = await fetchJson(`https://api.dapuhy.ga/api/socialmedia/musical?url=${q}&apikey=i`)
buffer = await getBuffer(lah.result.mp3.preview)
ikyy.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', filename: `${command}.mp3`, quoted: mek})
break; 
case 'ttwm':
reply('Loading...')
lah = await fetchJson(`https://api.dapuhy.ga/api/socialmedia/ttdownloader?url=${q}&apikey=i`)
buffer = await getBuffer(lah.result.wm)
ikyy.sendMessage(from, buffer, video, {mimetype: 'video/mp4', filename: `OjanBot.mp4`, quoted: mek, caption: `Nih Kak`})
break;
case 'ttnowm':
reply('Loading...')
lah = await fetchJson(`https://myhuman.cf/api/tiktok?url=${q}`)
buffer = await getBuffer(lah.nowm)
ikyy.sendMessage(from, buffer, video, {mimetype: 'video/mp4', filename: `OjanBot.mp4`, quoted: mek, caption: `Nih Kak`})
break
...
reply (mess.wait)
buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=53afc106252108ea4668c313`)
...
case 'nsfw_avatar':
reply (mess.wait)
buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=53afc106252108ea4668c313`)
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
buttonsMessage = {footerText:'follow @call.me.ido', imageMessage: imageMsg,
contentText:`©Luciver bot`,buttons,headerType:4}
...
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=53afc106252108ea4668c313&text=${ini_txt}`)
...
txt1 = args[0]
 txt2 = args[1]
 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=53afc106252108ea4668c313&text1=${txt1}&text2=${txt2}`)
 buttons = [{buttonId:  `${prefix}menu`,buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @call.me.ido', imageMessage: imageMsg,
 contentText:`©Luciver bot`,buttons,headerType:4}
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=53afc106252108ea4668c313&text=${ini_txt}`)
 buttons = [{buttonId:  `${prefix}menu`,buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @call.me.ido', imageMessage: imageMsg,
 contentText:`©Luciver bot`,buttons,headerType:4}
...
txt1 = args[0]
 txt2 = args[1]
 buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=53afc106252108ea4668c313&text1=${txt1}&text2=${txt2}`)
 buttons = [{buttonId:  `${prefix}menu`,buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @call.me.ido', imageMessage: imageMsg,
 contentText:`©Luciver bot`,buttons,headerType:4}
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=53afc106252108ea4668c313&text=${ini_txt}`)
 buttons = [{buttonId:  `${prefix}menu`,buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @call.me.ido', imageMessage: imageMsg,
 contentText:`©Luciver bot`,buttons,headerType:4}
...
if (banChats === true) return
 uptime = process.uptime()
  ...
  break
  case 'quotes':
  quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotes?apikey=53afc106252108ea4668c313`)
  ...
  break
  case 'quotesanime':
  quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=53afc106252108ea4668c313`)
  quotes = quotes.result
  quote = quotes.quote
  ...
  break
  case 'quotesdilan':
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/quotes/diLan?apikey=53afc106252108ea4668c313`)
  reply(get_result.result)

  break
  break
  case 'quotesimage':
  buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=53afc106252108ea4668c313`)
  buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
  imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {footerText:'follow @call.me.ido', imageMessage: imageMsg,
  ...
  case 'pantun':
  case 'bucin':
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/random/${command}?apikey=53afc106252108ea4668c313`)
...
type: 1,
  ...
  break
  case 'randomnama':
  anu = await fetchJson(`https://api.lolhuman.xyz/api/random/nama?apikey=53afc106252108ea4668c313`)
  kyyi = anu.result
...
type: 1,
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} Transformer`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/lk21?apikey=53afc106252108ea4668c313&query=${query}`)
...
break
case 'drakorongoing':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/drakorongoing?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} https://www.wattpad.com/707367860-kumpuLan-quote-tere-liye-tere-liye-quote-quote`)
  ini_url = args[0]
get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpad?apikey=53afc106252108ea4668c313&url=${ini_url}`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Rating : ${get_result.rating}\n`
...
if (args.length == 0) return reply(`Example: ${prefix + command} Tere Liye`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpadsearch?apikey=53afc106252108ea4668c313&query=${query}`)
get_result = get_result.result
...
break
case 'cerpen':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/cerpen?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
...
break
case 'ceritahoror':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/ceritahoror?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Desc : ${get_result.desc}\n`
ini_txt += `Story :\n${get_result.story}\n`
...
▹ ${prefix}bokep25
 ...
 sendButMessage(from, menu, `created follow @call.me.ido`, [
 {
buttonId:  `${prefix}menu`,
buttonText: {
  displayText: `⬡ BACK TO MENU `,
...
// Islami //
case 'listsurah':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/quran?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
ini_txt = 'List Surah:\n'
...
if (args.length < 1) return reply(`Example: ${prefix + command} 18 or ${prefix + command} 18/10 or ${prefix + command} 18/1-10`)
  urls = `https://api.lolhuman.xyz/api/quran/${args[0]}?apikey=53afc106252108ea4668c313`
...
if (args.length == 0) return reply(`Example: ${prefix + command} 18 or ${prefix + command} 18/10`)
  surah = args[0]
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/${surah}?apikey=53afc106252108ea4668c313`)
await ikyy.sendMessage(from, ini_buffer, audio, { quoted: freply, mimetype: Mimetype.mp4Audio })
break
case 'asmaulhusna':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/asmaulhusna?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Muhammad`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/kisahnabi/${query}?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Yogyakarta`)
  daerah = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${daerah}?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
...
anu = await axios.get(`http://api.lolhuman.xyz/api/tebak/family100?apikey=53afc106252108ea4668c313`)
...
if (tebakanime.hasOwnProperty(sender.split('@')[0])) return reply("Selesein yg sebelumnya dulu atuh")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebakchara?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/siapaaku?apikey=53afc106252108ea4668c313`)
  get_result = get_result.result
  jawaban = get_result.answer
  kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/kata?apikey=53afc106252108ea4668c313`)
 get_result = get_result.result
 jawaban = get_result.jawaban
...
if (tebaklirik.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/lirik?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
jawaban = get_result.answer
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
pertanyaan = get_result.question
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/jenaka?apikey=53afc106252108ea4668c313`)
  get_result = get_result.result
  jawaban = get_result.answer
  kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
  pertanyaan = get_result.question
 ...
 fs.writeFileSync("./database/tebakjenaka.json", JSON.stringify(tebakjenaka))
  ...
  case 'caklontong1'://Subscribe Hans BOT & Msz Pro			        
					...
					setTimeout( () => {
					ikyy.sendMessage(from, '_40 Detik lagi_…', text) // ur cods
					}, 10000) // 1000 = 1s,
					setTimeout( () => {
					ikyy.sendMessage(from, anu.result.soal, text, {quoted: mek })
					}, 0) // 1000 = 1s,
					break;
					case 'tebakkimia1'://Subscribe Hans BOT & Msz Pro			         
					anu = await fetchJson(`https://janbot-api.herokuapp.com/api/kuis/tebakkimia`, {method: 'get'})
					setTimeout( () => {
				    d.sendMessage(from, '*◉ Jawaban :* '+anu.lambang, text, {quoted: mek })
					}, 50000) // 1000 = 1s,
					setTimeout( () => {
					ikyy.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 40000) // 1000 = 1s,
					...
					setTimeout( () => {
					ikyy.sendMessage(from, anu.nama, text, {quoted: mek })
					}, 0) // 1000 = 1s,
					break				 
					case 'tebakbendera1'://Subscribe Hans BOT & Msz Pro			         
					anu = await fetchJson(`https://janbot-api.herokuapp.com/api/kuis/tebakbendera`, {method: 'get'})
					setTimeout( () => {
				    ikyy.sendMessage(from, '*◉ Jawaban :* '+anu.nama, text, {quoted: mek})
					}, 50000) // 1000 = 1s,
					setTimeout( () => {
					ikyy.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 40000) // 1000 = 1s,
					...
					setTimeout( () => {
					ikyy.sendMessage(from, anu.bendera, text, {quoted: mek })
					}, 0) // 1000 = 1s,
					break	         
			case 'tebakliriklagu1':
			        //Case By PojanGanz
				...
				setTimeout( () => {
				ikyy.sendMessage(from, tebak, text, {quoted: mek})
				}, 30000)
				setTimeout( () => {
				ikyy.sendMessage(from, '_10 Detik lagi..._', text)
				}, 20000)
				setTimeout( () => {
				ikyy.sendMessage(from, '_20 Detik lagi..._', text)
				}, 10000)
				setTimeout( () => {
				ikyy.sendMessage(from, '_30 Detik lagi..._', text)
				}, 2500)
				setTimeout( () => {

				}, 0)
                ikyy.sendMessage(from, gayakwwokw, text, {quoted: mek})				 
				break
					case 'tebakgambar1':
			        //Case By PojanGanz               
				...
				setTimeout( () => {
				ikyy.sendMessage(from, ojan, image, { caption: '_Tebak bro!!! gw ksi 30 dtk untk menjawab..', quoted: mek})
				}, 0)				 
				break
  case 'kimiakuis':
  if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 if (tebakimia.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/unsurkimia?apikey=53afc106252108ea4668c313`)
 get_result = get_result.result
...
if (tebakbendera.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/bendera?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
jawaban = get_result.name
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/susunkata?apikey=53afc106252108ea4668c313`)
  get_result = get_result.result
  jawaban = get_result.jawaban
  pertanyaan = get_result.pertanyaan
...
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/asahotak?apikey=53afc106252108ea4668c313`)
 get_result = get_result.result
 jawaban = get_result.jawaban
 kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
 pertanyaan = get_result.pertanyaan
...
if (caklontong.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/caklontong2?apikey=53afc106252108ea4668c313`)
get_result = get_result.result
jawaban = get_result.answer
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
pertanyaan = get_result.question
...
*Terimakasih Sudah Mendaftarkan Diri Dalam Database Bot Luciver*
...
setTimeout( () => {
 ikyy.updatePresence(from, Presence.composing)
 reply(`*Terimakasih Telah Terdaftar Di Vinz Botz *`)
  }, 2000)
break
case 'sfire1':{
...
Indosat = 085609217332
 ...
 break
 case 'culik':
              if (!kyy.key.fromMe) return fakestatus("LU SIAPA KONTOL? ");
 ...
 Wa.me/6285609217332`
 sendButMessage(from, titid, `follow @call.me.ido `, [
 {
...
reply(mess.wait)
 anu = await fetchJson(`https://api.lolhuman.xyz/api/soundcloud?apikey=53afc106252108ea4668c313&url=${q}`)
...
if (!q) return reply('Linknya?')
 ...
 data = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=53afc106252108ea4668c313&url=${q}`)
...
try {
  henid = args[0]
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/nhentai/${henid}?apikey=53afc106252108ea4668c313`)
  get_result = get_result.result
  ...
  reply(mess.wait)
  anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=53afc106252108ea4668c313`)
...
if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
 reply(mess.wait)
  query = args.join(" ")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/manga?apikey=53afc106252108ea4668c313&query=${query}`)
  get_result = get_result.result
...
reply(mess.wait)
 query = args.join(" ")
 get_result = await fetchJson(`https://api.lolhuman.xyz/api/anime?apikey=53afc106252108ea4668c313&query=${query}`)
 get_result = get_result.result
 ini_txt = `Id : ${get_result.id}\n`
 ini_txt += `Id MAL : ${get_result.idMal}\n`
 ini_txt += `Title : ${get_result.title.romaji}\n`
...
reply(mess.wait)
 query = args.join(" ")
 get_result = await fetchJson(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=53afc106252108ea4668c313&query=${query}`)
 get_result = get_result.result
 ini_txt = `Title : ${get_result.title}\n`
...
for (var y in link_dl[x]) {
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
  reply(mess.wait)
query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=53afc106252108ea4668c313&query=${query}`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Japanese : ${get_result.japanese}\n`
...
if (args.length == 0) return reply(`Example: ${prefix + command} https://nekopoi.care/isekai-harem-monogatari-episode-4-subtitle-indonesia/`)
  ini_url = args[0]
get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoi?apikey=53afc106252108ea4668c313&url=${ini_url}`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Isekai Harem`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoisearch?apikey=53afc106252108ea4668c313&query=${query}`)
get_result = get_result.result
ini_txt = ""
for (var x of get_result) {
  ini_txt += `\`\`\`🐥 Title : ${x.title}\`\`\`\n`
...
reply(mess.wait)
anu = await fetchJson(`https://lolhuman.herokuapp.com/api/storynime?apikey=53afc106252108ea4668c313`)
...
*[Wait] Tunggu Sebentar..*`
 ...
 query = args.join(" ")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/lirik?apikey=53afc106252108ea4668c313&query=${query}`)
  reply(get_result.result)
 ...
 query = args.join(" ")
  reply (mess.wait)
  ini_url = await fetchJson(`http://api.lolhuman.xyz/api/pinterest?apikey=53afc106252108ea4668c313&query=${query}`)
...
if (!isGroup) return reply(mess.only.group)
 ...
 profilePic = errorImg
  ...
  buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/rank?apikey=53afc106252108ea4668c313&img=${profilePic}&background=https://telegra.ph/file/443b6600636aed1d94acd.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
`
      ...
      case 'tiktokstalk':
             ...
             reply('Loading..')
              username = args[0]
             get_result = await fetchJson(`https://myhuman.cf/api/ttstalk?username=${username}`)
             get_result = get_result.user
			 rgl_result = await fetchJson(`https://myhuman.cf/api/ttstalk?username=${username}`)
...
//------------------< Sticker/Tools >-------------------
 ...
 if (!q) return reply(`Example: ${prefix + command} https://t.me/addstickers/LINE_Menhera_chan_ENG`)
  reply(mess.wait)
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/telestick?apikey=53afc106252108ea4668c313&url=${args[0]}`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji/${emoji}?apikey=53afc106252108ea4668c313`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji3/${emoji}?apikey=53afc106252108ea4668c313`)
await ikyy.sendMessage(from, ini_buffer, sticker, { quoted: freply })
case 'ttp':
case 'ttp2':
case 'ttp3':
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
anu1 = await getBuffer (`https://api.zeks.xyz/api/burning-image?apikey=53afc106252108ea4668c313&image=${tolink}`)
...
pjr = await getBuffer(`https://api.zeks.xyz/api/burning-image?apikey=53afc106252108ea4668c313&image${encodeURI(tolink)}`)
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
anu1 = `https://api.lolhuman.xyz/api/editor/triggered?apikey=53afc106252108ea4668c313&img=${tolink}`
sendStickerUrl(from, `${anu1}`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/editor/triggered?apikey=53afc106252108ea4668c313&img=${ini_url}`)
...
if (isImage || isQuotedImage) {
  ...
  let ane = await getBuffer(`https://api.zeks.xyz/api/burning-image?apikey=53afc106252108ea4668c313&image=${tolink}`)
...
if (isImage || isQuotedImage) {
 ...
 ranp = getRandom('.gif')
 rano = getRandom('.webp')
 var ini_buffer = `https://api.lolhuman.xyz/api/editor/triggered?apikey=53afc106252108ea4668c313&img=${tolink}`
...
if (args.length < 2) return 
 let ane = await getBuffer(`https://api.lolhuman.xyz/api/attp?apikey=53afc106252108ea4668c313&text=${mek}`)
...
if (args.length < 1) return reply(`Ketik ${prefix}lolkey [Apikeynya]`) 
 ...
 teks = args.join(' ')
  ...
  ikyy.sendMessage('6285929939498@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
  break
  case 'readall':
...
//------------------< Menunya Bang:v >-------------------
case 'infoig':
reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/@call.me.ido/`)
break
case 'ikyygroup':
reply('https://chat.whatsapp.com/IzjoWOHImUtFKOxM1WAr4l')
break
